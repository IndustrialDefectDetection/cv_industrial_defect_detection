...
export default function SignInCard({ googleEnabled }: { googleEnabled: boolean }) {
  ...
  return (
    <main className="flex min-h-screen bg-[radial-gradient(circle_at_top,_#dbeafe,_transparent_45%),linear-gradient(135deg,_#f8fafc,_#e8eef8)] dark:bg-[linear-gradient(145deg,_#0d0e10,_#090a0c)]">
      <div className="flex flex-1 items-center justify-center px-6 py-10">
        ...
        {/* Only offered when the server actually registered the provider.
            Showing it unconditionally meant a checkout with no OAuth client
            still advertised "Continue with Google", and every click failed. */}
        {googleEnabled && (
          <>
