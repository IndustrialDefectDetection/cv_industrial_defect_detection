...
def display_ai_summary_card():
    ...
    with st.expander("AI Daily Briefing", expanded=False):
        ...
        with col1:
            if cached:
                ...
                # Show executive summary from cached analysis (generated by AI specifically for this widget)
                ...
                if 'executive_summary' in analyses:
                    ...
                    # Fallback message if no executive_summary exists (older cache format)
